...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=139375 -o /tmp/$package $CURLOPTIONS --insecure
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:4D6FCE8D-6852-1229-1895-D22BF3F4DF00" "token:EA4BA666-7002-8826-C3B9-0DE2CDD15BF9" "policyid:166" "groupid:34"
# /opt/ds_agent/dsa_control -a dsm://agents.deepsecurity.trendmicro.com:443/ "tenantID:4D6FCE8D-6852-1229-1895-D22BF3F4DF00" "token:EA4BA666-7002-8826-C3B9-0DE2CDD15BF9" "policyid:166" "groupid:34"
